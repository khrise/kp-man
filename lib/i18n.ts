...
export const translations = {
  de: {
    ...
    weeklyParticipationOverview: "Wochenuebersicht Teilnahmen",
    loadingWeeklyOverview: "Wochenuebersicht wird geladen...",
    sortByPlayerName: "Nach Spielername",
    sortByRank: "Nach Rang",
    highestRankLabel: "Rang #{rank}",
    rankUnknown: "Rang ?",
    noRankInformation: "Keine Ranginformationen verfuegbar",
    ...
    invitationEmailTitle: "Einladungstext",
    invitationEmailDescription: "Kopieren Sie den Text und fügen Sie ihn in Ihr E-Mail-Programm ein.",
    copyEmailContent: "Text kopieren",
    emailContentCopied: "Kopiert!",
    invitationEmailUnavailable: "Einladungstext nicht verfügbar",
  ...
  en: {
    ...
    weeklyParticipationOverview: "Weekly participation overview",
    loadingWeeklyOverview: "Loading weekly overview...",
    sortByPlayerName: "Sort by player name",
    sortByRank: "Sort by rank",
    highestRankLabel: "Rank #{rank}",
    rankUnknown: "Rank ?",
    noRankInformation: "No rank information available",
    ...
    invitationEmailDescription: "Copy the text and paste it into your email client.",
    copyEmailContent: "Copy text",
    emailContentCopied: "Copied!",
    invitationEmailUnavailable: "Invitation text unavailable",
