...
export const translations = {
  de: {
    ...
    weeklyParticipationOverview: "Wochenübersicht",
    loadingWeeklyOverview: "Wochenübersicht wird geladen...",
    sortByPlayerName: "Nach Spielername",
    sortByRank: "Nach Rang",
    highestRankLabel: "#{rank}",
    rankUnknown: "?",
    noRankInformation: "Keine Ranginformationen verfügbar",
  ...
  en: {
    ...
    weeklyParticipationOverview: "Weekly overview",
